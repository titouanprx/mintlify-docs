...
|---|---|
| `message_received` | A new message was received in your inbox |
| `accepted_invitation` | A connection request you sent was accepted |
| `network_update` | Network badge count changed (new connection detected) |
...
Triggered when a new LinkedIn message is received.
...
### Network Update (Accepted Invitation)

Triggered when your network badge count increases, typically meaning a connection request was accepted.
...
<Note>
  When subscribing to `accepted_invitation`, the API performs an initial sync of your connections. When a network update is detected, it compares against the stored connections to identify who is new.
</Note>
