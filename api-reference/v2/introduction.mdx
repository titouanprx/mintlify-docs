...
LinkupAPI connects your product or AI agent to LinkedIn, WhatsApp, and Email. One unified API to automate outreach, find contacts, and gather market insights for **sales** and **recruitment**.

## What You Can Build

<CardGroup cols={2}>
  <Card title="Sales Automation" icon="chart-line">
    Generate leads, automate outreach on LinkedIn/WhatsApp/Email, track funding signals, and enrich company data in real-time.
  </Card>
