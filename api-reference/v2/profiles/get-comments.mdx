...
<Note>This endpoint consumes **1 credit per 10 results** returned. The platform returns up to **50 comments per internal request**, so requesting `count: 100` triggers only 2 upstream calls.</Note>
