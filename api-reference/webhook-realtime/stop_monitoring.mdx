...
api: 'POST /v1/webhooks/accounts/{account_id}/stop'
...
<Warning>
  **LinkedIn Only:** This endpoint only works for LinkedIn accounts. To stop WhatsApp monitoring, delete the account entirely.
</Warning>
