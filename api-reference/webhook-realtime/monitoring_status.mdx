...
description: 'Check the current monitoring status of a webhook account'
---

Retrieve the current monitoring status for a registered LinkedIn or WhatsApp webhook account.
