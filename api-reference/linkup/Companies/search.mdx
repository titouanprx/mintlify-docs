...
<ParamField body="total_results" type="integer" default="10">
  Number of companies to return (max 100)
</ParamField>
...
- The total_results parameter is capped at 100 companies per request
- Results are paginated with a maximum of 50 companies per page
- Company size filter uses LinkedIn's standard employee count ranges
