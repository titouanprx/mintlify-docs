...
- **Company Page Replies**: When `company_url` is provided, the reply will be posted on behalf of the company page. You must have admin rights on the company page to use this feature.
