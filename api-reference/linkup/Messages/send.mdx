...
<ParamField body="media_file" type="object">
  Media file in base64 format with metadata (second priority)
  <Expandable title="media_file structure">
    <ParamField body="data" type="string" required>
      Base64 encoded file data (can include data URL prefix like "data:image/jpeg;base64,...")
    </ParamField>
