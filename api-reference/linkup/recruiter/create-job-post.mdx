...
<ParamField body="screening_questions[].favorableFloor" type="number">
  For numeric questions, the minimum acceptable value (e.g., years of experience)
</ParamField>

<ParamField body="screening_questions[].experienceYears" type="number">
  For PROFESSIONAL_EXPERIENCE questions, years of experience required
</ParamField>

<ParamField body="screening_questions[].languageLevel" type="string">
