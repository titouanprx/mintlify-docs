...
- `INDUSTRY_EXPERIENCE`: Years of experience in a specific industry (requires `parameterValue` with industry name)(industry list: `api.linkupapi.com/v1/tool/industries`)
