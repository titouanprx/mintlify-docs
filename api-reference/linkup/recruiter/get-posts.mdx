...
description: 'Retrieve your posted LinkedIn job listings with complete details'
---

Retrieve detailed information about the job postings you have created on LinkedIn, including complete job details such as description, applicant statistics, workplace type, and industry.

<Note>
  **Credit Usage:** 1 credit per job posting retrieved. Each job posting includes complete details.
</Note>
...
<ResponseExample>
```json Success Response (Multiple Posts)
{
  "status": "success",
  "data": {
    "total_results": 1,
