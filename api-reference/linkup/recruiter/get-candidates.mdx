...
api: 'GET /v1/jobs/get-candidates'
...
<ParamField query="count" type="string" default="10">
  Number of candidates to retrieve
</ParamField>

<ParamField query="start" type="string" default="0">
  Starting position for pagination
</ParamField>

<ParamField query="sortType" type="string" default="RELEVANCE">
  Sorting method. Options: RELEVANCE, DATE
</ParamField>

<ParamField query="sortOrder" type="string" default="DESCENDING">
  Sorting order. Options: ASCENDING, DESCENDING
</ParamField>

<ParamField query="ratings" type="string" default="GOOD_FIT,MAYBE,UNRATED">
...
<ParamField query="skills" type="string">
  Filter candidates by skills, comma-separated (e.g., "Python,Marketing")
</ParamField>

<ParamField query="yearsOfExperience" type="string">
  Filter by years of experience, comma-separated (e.g., "THREE_TO_FIVE_YEARS,SIX_TO_TEN_YEARS")
</ParamField>

<ParamField query="country" type="string" default="FR">
  Country code for proxy selection. Available: (US,UK,FR)
</ParamField>

<ParamField query="login_cookie" type="string" required>
