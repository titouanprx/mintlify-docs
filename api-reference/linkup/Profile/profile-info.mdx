...
<ResponseField name="data" type="object">
  <Expandable title="Properties">
    ...
    <ResponseField name="isOpenToWork" type="boolean">
      Indicates if the profile owner is open to job opportunities
    </ResponseField>
    
    <ResponseField name="isHiring" type="boolean">
      Indicates if the profile owner is currently hiring
    </ResponseField>
  </Expandable>
</ResponseField>
