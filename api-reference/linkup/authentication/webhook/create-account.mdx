...
api: 'POST /linkedin/webhook/accounts'
description: 'Register a LinkedIn account for webhook monitoring'
---

Register a new LinkedIn account to receive real-time webhook notifications for messages and activities.
...
### Notes
- Each user can create multiple LinkedIn accounts for monitoring
- The account will be created with `is_active: false` by default
- Use the start monitoring endpoint to begin receiving webhooks
- The webhook URL must be accessible and respond with 2xx status codes
