...
<Warning>
  **Credit Usage:** Real-time monitoring consumes **10 credits per day** (1 credit every 144 minutes) per active account. This is a resource-intensive feature but extremely powerful for real-time LinkedIn messaging.
</Warning>
