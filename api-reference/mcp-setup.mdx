...
- **API key** — pass your key via the `x-api-key` header. Simplest option, works everywhere.
- **OAuth 2.1** — for clients that support it (Claude, ChatGPT). You approve access from the LinkupAPI dashboard — no need to paste your key into the client.
